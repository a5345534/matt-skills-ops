...
Repository: `a5345534/matt-skills-ops`. The local `origin` remote points to it.
...
- **Blocking**: use GitHub’s native issue dependencies; fall back to a `Blocked by: #<n>` line if unavailable.
