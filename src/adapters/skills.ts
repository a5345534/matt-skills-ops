    ...
    async prepareImplement(input) {
      ...
      return {
        ...
        prompt: [
          `/implement`,
          "",
          `Implement tracker issue #${input.ticketNumber}: ${input.title}`,
          "",
          "Work only in this Implementation workspace. Commit locally when done.",
          "Do not push, edit tracker issues, or mutate remote workflow state.",
          "",
      ...
      if (input.kind === "target-refresh") {
        return {
          ...
          prompt: [
            ...
            "Do not push, edit tracker issues, rebase, or mutate remote workflow state.",
